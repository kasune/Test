...
public class ConvertFile extends DefaultHandler{
    ...
    private final String BASE_DIRECTORY   = "D:\\git\\Test\\101\\101\\excel\\";
            ...
            out = new PrintWriter(new BufferedWriter(new FileWriter(BASE_DIRECTORY + "report.csv")));
             ...
             out.println("Date,"	+
                   ...
                   /* "Total Avg Register Roamers," +*/
                    ...
                    "Country");
            System.out.println("Date,"	+ "Network," + "GSM Register Attempt," +  "GPRS Register Attempt," +  "GSM Register Success," + "GPRS Register Success," +
                    "GSM Success Ratio (%)," +  "GPRS Success Ratio (%)," + "GSM Avg Register Roamers," + "GPRS Avg Register Roamers," + "Total Avg Register Roamers," +
                    "GSM Out of Total Roamer(%)," +
                    "GPRS Out of Total Roamer(%)," +
                    "Country");
        ...
        if ((data.length()>0) && (endSummary)){
            ...
            if (isNumber) {
                ...
                //if ((columnIndex==19) || (columnIndex==27)){
                    if ((columnIndex==200) || (columnIndex==300)){
    ...
    public void endElement(String uri, String localName, String qName) {
        if(qName.equalsIgnoreCase("Row")){
            ...
            if ((endSummary) && (!isTitle)){
                ...
                System.out.println(rLine+countryName);
            }
